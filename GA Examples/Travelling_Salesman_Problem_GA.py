...
def creating_population(pop_size):
    """
    ...
    for i in range(pop_size):
        pop.append(generating_chromosome())

    return pop


def fittest_fun(chromosome):
    """
...
def selection(population, scale):
    """
...
def stopping_function(best_values):
    """
...
def generating_algorithm(generation_times=50, pop_size=5000):
    """
...
if __name__ == '__main__':
    ...
    inf = float('inf')
    distances = [
        [0, 2, inf, 12, 5, 6, 20, 10, 9, 12],    # 0
        [2, 0, 4, 8, inf, 3, inf, 19, 20, 31],   # 1
        [inf, 4, 0, 3, 3, 3, 9, 9, 10, 32],      # 2
        [12, 8, 3, 0, 10, 22, 1, 20, inf, 21],   # 3
        [5, inf, 3, 10, 0, 3, 2, 12, 2, 9],      # 4
        [3, 9, 19, inf, 10, 0, 20, 88, 22, 1],   # 5
        [2, 3, 4, 1, 39, 12, 0, 12, 12, 11],     # 6
        [12, 22, 1, 19, 29, 22, 1, 0, 3, 1],     # 7
        [8, inf, 29, 11, 29, 1, 19, 29, 0, 22],  # 8
        [3, 19, 12, 92, 19, inf, 2, 3, 11, 0]    # 9
    ]
    cities_num = 10
